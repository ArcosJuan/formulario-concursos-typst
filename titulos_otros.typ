...
#let titulos = (
  ...
  // (indicando organismo que la otorgó, lugar, director y tema trabajo, lapso, categoría
  // de la beca y dedicación, categoría de investigador, etc).
  becas_distinciones: nc,
